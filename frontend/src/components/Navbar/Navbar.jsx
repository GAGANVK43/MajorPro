...
import { FaHeartbeat, FaUser, FaSignOutAlt, FaBars, FaTimes, FaCircle, FaCog, FaMapMarkerAlt } from "react-icons/fa";
    ...
    <nav className="navbar-container">
      <div className="navbar-content">
        ...
        <ul className={`nav-links ${menuOpen ? "mobile-open" : ""}`}>
          ...
          <li>
            <NavLink to="/find-care" className={({ isActive }) => (isActive ? "nav-link active" : "nav-link")}>
              Find Care
            </NavLink>
          </li>
          <li>
            ...
            <div className="user-profile-wrapper">
              ...
              {userDropdown && (
                <div className="user-dropdown-menu">
                  ...
                  <NavLink to="/find-care" className="dropdown-item" onClick={() => setUserDropdown(false)}>
                    <FaMapMarkerAlt /> Find Care Near You
                  </NavLink>
